module testTypes  
    ...
    type RegisterName = R0 | R1 | R2 | R3 | R4 | R5| R6 | R7 | R8 | R9 | R10 | R11 | R12
    ...
    type ArithLogicInstr = {Op: ArithLogicOp; CondCode:ConditionCode  ;S:bool; Rd: RegisterName; Rn: RegisterName; Op2: FlexOp}
    type MoveInstr = {Op: MoveOp; CondCode:ConditionCode  ;S:bool; Rd: RegisterName; Op2: FlexOp}
    type TestInstr = {Op: TestOp; CondCode:ConditionCode  ;Rn: RegisterName; Op2: FlexOp}
    ...
    type ShiftInstr = {Op: ShiftOp; S:bool;CondCode:ConditionCode  ;Rd: RegisterName; Rn: RegisterName; Op2: ImReg} //Last parameter is option becase RRX only has 2 registers as parameters
